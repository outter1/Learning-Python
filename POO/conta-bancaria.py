class ContaBancaria:
    ...
    def sacar(self, valor):
        if 0 < valor <= self.__saldo:
            ...
            print("Valor de saque inválido inválido")
    ...
    setter: é usado para definir(escrever) ou alterar o valor de um atribut privado de uma classe'''
    
    #Getter para o titular(somente leitura)
    @property #getter - cria um método que ser acessado como se fosse um atributo
    def titular(self):
